...
Base = 'http://rosoli98.blogspot.com/2017/02/addon-prueba.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.Cutisol') #    modificar("el nombre de tu addons")
